...
//     /// TODO(@adr1anh): Find out how to remove rotation which is always curr
//     Selector(usize),
...
//         match expr {
//             Expr::Slack(d) => self.add_calculation(Calculation::Store(ValueSource::Slack(*d))),
//             Expr::Constant(scalar) => self.add_constant(scalar),
//             Expr::Selector(selector) => {
//                 self.add_calculation(Calculation::Store(ValueSource::Selector(selector.index())))
//             }
//             Expr::Fixed(query) => {
...
//         let (homogenous_poly, _) = flattened_poly.homogenize();

//         let eval_poly = homogenous_poly.evaluate(
//             slack,
//             constant,
//             selector_column,
//             fixed_column,
